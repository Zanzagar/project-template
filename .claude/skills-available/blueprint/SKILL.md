...
To update, check the upstream ECC repository for changes:

```bash
gh api repos/affaan-m/everything-claude-code/contents/skills/blueprint/SKILL.md \
  -H 'Accept: application/vnd.github.raw' > /tmp/ecc-blueprint.md
diff .claude/skills/blueprint/SKILL.md /tmp/ecc-blueprint.md
```
